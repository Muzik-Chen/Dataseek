...
<<<<<<< HEAD
import "./chunk-WDBIA2OH.js";
import "./chunk-7RI4PWSE.js";
import {
  init,
  throttle
} from "./chunk-Q6TJ2UTO.js";
import "./chunk-7UKI6D3B.js";
=======
import "./chunk-WYTCPDUF.js";
import "./chunk-IZEB2HNP.js";
import {
  init,
  throttle
} from "./chunk-NFVDR5IU.js";
import "./chunk-4VFBKWIC.js";
...
var ECharts_default = defineComponent({
  ...
  setup(props, { attrs, expose, slots }) {
    ...
    function resolveUpdateOptions(plan) {
      const result = {};
      const replacements = ((plan == null ? void 0 : plan.replaceMerge) ?? []).filter((key) => key != null);
    ...
    watch(realTheme, (theme) => {
      var _a;
      (_a = chart.value) == null ? void 0 : _a.setTheme(theme || {});
    }, { deep: true });
    watchEffect(() => {
