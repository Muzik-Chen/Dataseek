...
} from "./chunk-TYGVEHCM.js";
import {
  install as install26,
  install10 as install35,
  install11 as install36,
  install12 as install37,
  install13 as install38,
  install14 as install39,
  install15 as install40,
  install18 as install41,
  install19 as install42,
  install2 as install27,
  install20 as install43,
  install21 as install44,
  install22 as install45,
  install23 as install46,
  install24 as install47,
  install25 as install48,
  install26 as install49,
  install27 as install50,
  install28 as install51,
  install3 as install28,
  install4 as install29,
  install5 as install30,
  install6 as install31,
  install7 as install32,
  install8 as install33,
  install9 as install34
} from "./chunk-7NHEMV7I.js";
=======
  install2
} from "./chunk-JUBWIOLZ.js";
import {
...
<<<<<<< HEAD
} from "./chunk-WDBIA2OH.js";
import "./chunk-7RI4PWSE.js";
=======
} from "./chunk-WYTCPDUF.js";
import "./chunk-IZEB2HNP.js";
>>>>>>> 21e3c77773c3c723533ac403c37b7d726a663c22
import {
  Axis_default,
  Chart_default,
...
import {
  install as install52,
  install2 as install53
} from "./chunk-BWLS5SAQ.js";
=======
...
function parseAxisBreakOption(breakOptionList, scale, opt) {
  var parsedBreaks = [];
  if (!breakOptionList) {
    return {
      breaks: parsedBreaks
...
use([install53]);
use([install52]);
use([install, install2, install3, install4, install5, install7, install8, install9, install10, install11, install12, install13, install15, install16, install17, install18, install19, install20, install21, install22, install23, install24, install25]);
use(install27);
use(install28);
use(install6);
use(install29);
