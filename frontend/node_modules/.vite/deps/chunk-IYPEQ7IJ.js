...
var View = (
  ...
  (function(_super) {
    ...
    View2.prototype.dataToPoint = function(data, noRoam, out) {
      ...
      out = out || [];
      return transform ? applyTransform(out, data, transform) : copy2(out, data);
    };
    View2.prototype.pointToData = function(point, reserved, out) {
      out = out || [];
      var invTransform = inner2(this).mtOverallInv;
      return invTransform ? applyTransform(out, point, invTransform) : copy2(out, point);
    };
...
function viewCoordSysCopyOverallMatrix(out, viewCoordSys) {
  return copy(out || [], inner2(viewCoordSys).mtOverall);
}
...
function legacyCopyOverallTrans(target, overallTrans, mtOverall, mtOverallInv) {
  if (target) {
    ...
    copy(target.transform || (target.transform = []), mtOverall);
    copy(target.invTransform || (target.invTransform = []), mtOverallInv);
  }
}
...
//# sourceMappingURL=chunk-IYPEQ7IJ.js.map
